...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Usuario.rol'
        db.alter_column('Administration_usuario', 'rol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Administration.Rol'], null=True))

        # Changing field 'Usuario.direccion'
        db.alter_column('Administration_usuario', 'direccion', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Usuario.tipo_usuario'
        db.alter_column('Administration_usuario', 'tipo_usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Administration.TipoUsuario'], null=True))

        # Changing field 'Usuario.telefono'
        db.alter_column('Administration_usuario', 'telefono', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Usuario.rol'
        db.alter_column('Administration_usuario', 'rol_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Administration.Rol']))

        # Changing field 'Usuario.direccion'
        db.alter_column('Administration_usuario', 'direccion', self.gf('django.db.models.fields.CharField')(default=None, max_length=500))

        # Changing field 'Usuario.tipo_usuario'
        db.alter_column('Administration_usuario', 'tipo_usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Administration.TipoUsuario']))

        # Changing field 'Usuario.telefono'
        db.alter_column('Administration_usuario', 'telefono', self.gf('django.db.models.fields.CharField')(default=None, max_length=10))
    ...
    models = {
        ...
        'Administration.usuario': {
            ...
            'direccion': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rol': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['Administration.Rol']", 'null': 'True', 'blank': 'True'}),
            'telefono': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'tipo_usuario': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['Administration.TipoUsuario']", 'null': 'True', 'blank': 'True'}),
