...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('Administration_usuario', 'user_id')

        # Deleting field 'Usuario.id'
        db.delete_column('Administration_usuario', 'id')

        # Adding field 'Usuario.user_ptr'
        db.add_column('Administration_usuario', 'user_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Usuario.user'
        db.add_column('Administration_usuario', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True),
                      keep_default=False)

        # Adding field 'Usuario.id'
        db.add_column('Administration_usuario', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True),
                      keep_default=False)

        # Deleting field 'Usuario.user_ptr'
        db.delete_column('Administration_usuario', 'user_ptr_id')
