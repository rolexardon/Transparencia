...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EncuestaTempData.codigo_segmento'
        db.delete_column('Encuesta_encuestatempdata', 'codigo_segmento')

        # Adding field 'EncuestaTempData.segmento'
        db.add_column('Encuesta_encuestatempdata', 'segmento', self.gf('django.db.models.fields.CharField')(default='', max_length=2, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'EncuestaTempData.codigo_segmento'
        db.add_column('Encuesta_encuestatempdata', 'codigo_segmento', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Deleting field 'EncuestaTempData.segmento'
        db.delete_column('Encuesta_encuestatempdata', 'segmento')
