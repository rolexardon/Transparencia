...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Encuesta.alumnos'
        db.add_column('Encuesta_encuesta', 'alumnos',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Adding field 'EncuestaTemp.alumnos'
        db.add_column('Encuesta_encuestatemp', 'alumnos',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Encuesta.alumnos'
        db.delete_column('Encuesta_encuesta', 'alumnos')

        # Deleting field 'EncuestaTemp.alumnos'
        db.delete_column('Encuesta_encuestatemp', 'alumnos')
