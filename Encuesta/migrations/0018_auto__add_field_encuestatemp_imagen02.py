...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EncuestaTemp.imagen02'
        db.add_column('Encuesta_encuestatemp', 'imagen02',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EncuestaTemp.imagen02'
        db.delete_column('Encuesta_encuestatemp', 'imagen02')
