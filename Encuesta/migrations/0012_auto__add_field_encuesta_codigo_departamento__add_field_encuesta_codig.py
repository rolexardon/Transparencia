...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Encuesta.codigo_departamento'
        db.add_column('Encuesta_encuesta', 'codigo_departamento', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Administration.Departamento']), keep_default=False)

        # Adding field 'Encuesta.codigo_municipio'
        db.add_column('Encuesta_encuesta', 'codigo_municipio', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Administration.Municipio']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Encuesta.codigo_departamento'
        db.delete_column('Encuesta_encuesta', 'codigo_departamento_id')

        # Deleting field 'Encuesta.codigo_municipio'
        db.delete_column('Encuesta_encuesta', 'codigo_municipio_id')
