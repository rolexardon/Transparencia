...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ListadoDocentesTemp'
        db.create_table('Encuesta_listadodocentestemp', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Encuesta.Encuesta'])),
            ('segmento', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('id_personal', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('Encuesta', ['ListadoDocentesTemp'])

        # Adding model 'ListadoDocentes'
        db.create_table('Encuesta_listadodocentes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Encuesta.Encuesta'])),
            ('segmento', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('id_personal', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal('Encuesta', ['ListadoDocentes'])


    def backwards(self, orm):
        
        # Deleting model 'ListadoDocentesTemp'
        db.delete_table('Encuesta_listadodocentestemp')

        # Deleting model 'ListadoDocentes'
        db.delete_table('Encuesta_listadodocentes')
