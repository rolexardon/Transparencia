...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EncuestaTemp.prueba'
        db.add_column('Encuesta_encuestatemp', 'prueba', self.gf('django.db.models.fields.CharField')(default='p', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EncuestaTemp.prueba'
        db.delete_column('Encuesta_encuestatemp', 'prueba')
    ...
    models = {
        ...
        'Encuesta.encuestatemp': {
            ...
            'prueba': ('django.db.models.fields.CharField', [], {'default': "'p'", 'max_length': '25'}),
