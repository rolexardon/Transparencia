...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Encuesta.imagen01'
        db.add_column('Encuesta_encuesta', 'imagen01',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100),
                      keep_default=False)

        # Adding field 'Encuesta.imagen02'
        db.add_column('Encuesta_encuesta', 'imagen02',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Encuesta.imagen01'
        db.delete_column('Encuesta_encuesta', 'imagen01')

        # Deleting field 'Encuesta.imagen02'
        db.delete_column('Encuesta_encuesta', 'imagen02')
    ...
    models = {
        ...
        'Encuesta.encuesta': {
            ...
            'imagen01': ('django.db.models.fields.files.ImageField', [], {'default': 'None', 'max_length': '100'}),
            'imagen02': ('django.db.models.fields.files.ImageField', [], {'default': 'None', 'max_length': '100'}),
        ...
        'Encuesta.encuestatemp': {
            ...
            'alumnos': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'codigo': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
