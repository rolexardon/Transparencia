...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EncuestaTemp.codigo_centro'
        db.alter_column('Encuesta_encuestatemp', 'codigo_centro_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Administration.CentroEducativo'], null=True))


    def backwards(self, orm):
        
        # Changing field 'EncuestaTemp.codigo_centro'
        db.alter_column('Encuesta_encuestatemp', 'codigo_centro_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.date(2011, 11, 11), to=orm['Administration.CentroEducativo']))
    ...
    models = {
        ...
        'Encuesta.encuestatemp': {
            ...
            'codigo_centro': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Administration.CentroEducativo']", 'null': 'True', 'blank': 'True'}),
