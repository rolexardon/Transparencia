...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ListadoDocentesTemp.encuesta'
        db.alter_column('Encuesta_listadodocentestemp', 'encuesta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Encuesta.EncuestaTemp']))


    def backwards(self, orm):
        
        # Changing field 'ListadoDocentesTemp.encuesta'
        db.alter_column('Encuesta_listadodocentestemp', 'encuesta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Encuesta.Encuesta']))
