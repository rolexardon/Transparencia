...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Encuesta.fecha_apertura'
        db.add_column('Encuesta_encuesta', 'fecha_apertura', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 11, 25)), keep_default=False)

        # Adding field 'EncuestaTemp.fecha_apertura'
        db.add_column('Encuesta_encuestatemp', 'fecha_apertura', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Encuesta.fecha_apertura'
        db.delete_column('Encuesta_encuesta', 'fecha_apertura')



        # Deleting field 'EncuestaTemp.fecha_apertura'
        db.delete_column('Encuesta_encuestatemp', 'fecha_apertura')
